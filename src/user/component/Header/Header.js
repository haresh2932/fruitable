                    ...
                    <nav className={`navbar navbar-light  navbar-expand-xl `}>
                        ...
                        <div className={`collapse navbar-collapse `} id="navbarCollapse">
                            <div className={`navbar-nav mx-auto '}`}>
                                ...
                                <NavLink to='/shopDetails' className="nav-item nav-link active">Shop Detail</NavLink>
                            ...
                            <div className="d-flex m-3 me-0">
                                <button className="btn-search btn border border-secondary btn-md-square rounded-circle bg-white me-1" data-bs-toggle="modal" data-bs-target="#searchModal"><i className="fas fa-search text-primary" /></button>
                                ...
                                <a href="#" className="position-relative me-2 my-auto">
                                    <NavLink
                                        to='/cart'
