...
// import { getfruites } from '../../../redux/Action/fruites.action';
...
function Home(props) {
    ...
    let owl = {
        ...
        navText: [
            ...
            '<div class="owl-prev"><i class="bi bi-arrow-right"></i></div>'
        ],
    ...
    //     try {
    //         const response = await axios.get('http://localhost:8000/fruites');
    ...
    return (
        <div>
                            ...
                            <div id="carouselId" className="carousel slide position-relative" data-bs-ride="carousel">
                                <div className="carousel-inner" role="listbox">
                                    <div className="carousel-item active rounded">
                                        <img src="img/hero-img-1.png" className={`img-fluid w-100 h-100  rounded ${themeContext.theme === 'dark' ? 'bg-dark' : 'bg-secondary'}`} alt="First slide" />
                    ...
                    <div className="row g-4">
                        {
                            facilities.facilities.map((v) => (
                                <div className="col-md-6 col-lg-3">
                                    <div className={`featurs-item text-center rounded  p-4 ${themeContext.theme === 'dark' ? 'bg-dark' : 'bg-light'}`}>
                ...
                <div className="container py-5">
                    <div className="row g-4 justify-content-center">
                        <div className="col-md-6 col-lg-4">
                            <a href="#">
                                <div className={`service-item rounded border border-secondary  bg-secondary`}>
            ...
            <div className={`container-fluid banner my-5 ${themeContext.theme === 'dark' ? 'bg-dark' : ' bg-secondary'}`}>
                <div className="container py-5">
                    <div className="row g-4 align-items-center">
                        <div className="col-lg-6">
                            <div className="py-4">
                                <h1 className="display-3 text-white">Fresh Exotic Fruits</h1>
                                <p className="fw-normal display-3 text-black mb-4">in Our Store</p>
                                ...
                                <a href="#" className="banner-btn btn border-2 border-white rounded-pill text-black py-3 px-5">BUY</a>
                            </div>
                        </div>
                        <div className="col-lg-6">
                ...
                <div className="container py-5">
                    ...
                    <div className="row g-4">
                        <div className="col-lg-6 col-xl-4">
                            <div className={`p-4 rounded ${themeContext.theme === 'dark' ? 'border border-warning' : 'bg-light'}`}>
            ...
            <div className="container-fluid testimonial py-5">
                <div className="container py-5">
                    ...
                    <OwlCarousel {...tes} className="owl-carousel testimonial-carousel">
                        <div className={`testimonial-item img-border-radius  ${themeContext.theme === 'dark' ? 'border border-warning' : 'bg-light'} rounded p-4`}>                            <div className="position-relative ">
                        ...
                        <div className={`testimonial-item img-border-radius  ${themeContext.theme === 'dark' ? 'border border-warning' : 'bg-light'} rounded p-4`}>
                            <div className="position-relative">
                                <i className="fa fa-quote-right fa-2x text-secondary position-absolute" style={{ bottom: 30, right: 0 }} />
                                <div className="mb-4 pb-4 border-bottom border-secondary">
                                    <p className="mb-0">Lorem Ipsum is simply dummy text of the printing Ipsum has been the industry's standard dummy text ever since the 1500s,
